...
public class BodyPartQuiz {
	...
	public int peopleGuessing( int score, String answer ) {
	...
	private void startQuiz() {
		...
		score = peopleGuessing(score, "Arnold");
		score = peopleGuessing(score, "Leonardo");
		score = peopleGuessing(score, "Morgan");
		score = peopleGuessing(score, "Jack");
